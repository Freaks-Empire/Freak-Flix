...
- [x] **SEC-02**: Local file operations reject directory traversal attempts.
...
- [x] **SEC-05**: Adult library remains hidden by default and requires explicit opt-in toggle.
