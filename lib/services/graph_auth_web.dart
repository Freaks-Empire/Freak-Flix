...
/// 
/// Uses PKCE (Proof Key for Code Exchange) with popup window OAuth flow.
/// This is required for web because Microsoft's OAuth endpoints don't support CORS
/// for direct fetch requests from browsers.
