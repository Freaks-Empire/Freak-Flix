...
class _TaskMonitorCardState extends State<TaskMonitorCard> {
  ...
  Widget build(BuildContext context) {
    // Ghost State: Animate In/Out based on visibility
    return AnimatedSize(
      ...
      child: widget.isVisible 
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        if (widget.logs.isEmpty)
                          ...
                          ...widget.logs.take(10).map((log) => Padding( // Limit logs
        ...
        : const SizedBox.shrink(), // Ghost State: Completely gone
    );
  }
}
