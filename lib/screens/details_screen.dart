...
class _DetailsScreenState extends State<DetailsScreen> {
  ...
  Future<void> _loadDetails() async {
    ...
    if (_current.tmdbId == null) {
      // If we don't have ID, try to enrich first? Assumed already enriched usually.
      // But if it's a stub from Discover, it has ID.
      // If local item, it might have ID if matched.
    }
                ...
                children: [
                  ...
                  Row(
                    children: [
                      ...
                      // Stub "Similars" button logic? Or just scroll down.
                      // User screenshot shows "+", "Download", "Similars". 
                      // We'll stick to simple Play + toggle Watched for now.
                      OutlinedButton.icon(
