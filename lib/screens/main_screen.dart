...
String mainScreenNavigationUnavailableMessage() {
  return 'Navigation shell unavailable. Please restart the app.';
}
...
class MainScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (navigationShell == null) {
      return Scaffold(
        body: Center(
          child: Text(mainScreenNavigationUnavailableMessage()),
        ),
      );
    }
